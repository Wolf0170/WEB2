    ...
    <div class="classQuanLy">
      ...
      <div class="menu">
        ...
        <div class="logo">
          <div>
            <img
              src="../assets/img/340090310_1374771333370992_3765660545192117681_n.jpg"
              alt=""
            />
        ...
        <div class="innermenu">
          <ul>
            <li>
              <a href="Trangchu.html" class="menu-1">Thống kê khách hàng</a>
            </li>
            <li>
              <a href="./ThongKeSanPham.html" class="menu-1"
                >Thống kê sản phẩm</a
              >
            </li>
            ...
            <li>
              <a href="./Quanlynv.html" class="menu-1">Tài khoản khách hàng</a>
            </li>
          </ul>
        </div>
      </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <img
                          src="../img/product/<?php echo $row['HinhAnh']?>"
                      ...
                      <td>
                        <a href="../admin/admin.product-edit.php?id=<?php echo $row['MaSP']; ?>">
                          <button>Sửa</button>
                        </a>
                        <button type="button" class="delete-btn" data-id="<?php echo $row['MaSP']; ?>">Xóa</button>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
  ...
  document.addEventListener("DOMContentLoaded", function () {
      document.querySelectorAll(".delete-btn").forEach((button) => {
          button.addEventListener("click", function () {
              ...
              fetch(`../../controller/admin/warning-box.php?id=${productId}`)
      ...
      document.addEventListener("click", function (event) {
          if (event.target.classList.contains("btn-save")) {
              ...
              let url = action === "delete"
                  ? `../../controller/admin/delete-product.php?id=${productId}`
                  : `../../controller/admin/hide-product.php?id=${productId}`;
